...
nycShortestFlight
```
The shortest flight out of any NYC airport is `r nycShortestFlight` mins long
...
There were `r nrow(nycUA12Jan2013)` flights by United Airlines on Jan 12th 2013
...
```
The average arrival delay for all airports combined in Jan 2013 is `r nyc_Jan_2013_arr_delay`
...
```
The median arrival delay for all airports and all airlines combined in Jan 2013 is `r nyc_Jan_2013_arr_delay_median`

Q. Based on your answers to the two questions above, what can you say about the distribution of arrival delays? Provide your answer in a text paragraph form.

Ans - Since the median is negative but the average delay is positive, this shows that there are a few flights which have high average arrival delays thus skewing the overall average towards positive
...
MedianAirgain<- median(nycflights$airgain, na.rm= TRUE)

```

Mean - `r MeanAirgain`

Median - `r median(nycflights$airgain, na.rm= TRUE)`
...
b) Answer the questions:
  ...
  Yes, on an average the airlines gain `r MeanAirgain` mins. 
